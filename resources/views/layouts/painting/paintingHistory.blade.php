...
@section('content')
    <main>
        ...
        <a href="{{ url('/dashboardpainting') }}" class="btn btn-outline-secondary">DASHBOARD</a>
        <div class="card">
            <div class="card-body">
                                    ...
                                    <td>
                                        @foreach ($item['auditors'] as $auditor)
                                            <li>{{ $auditor->auditor_name }}
                                                ...
                                                <a href="{{ route('detailPaintingHistory', ['id_user' => $auditor->id, 'date' => $item['date']]) }}"
                                                    class="btn btn-primary my-3 btn-sm">Detail</a>
                                            </li>
                                        @endforeach
                                    </td>
                                </tr>
