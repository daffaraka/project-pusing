...
@section('content')
    <main>
        <div class="container-fluid px-4">
            ...
            <a href="{{ url('/paintingHistory') }}" class="btn btn-outline-secondary">HISTORY</a>
                        ...
                        <tbody>
                            @foreach ($auditorsPainting as $auditor)
                                ...
                                <tr style="{{ $rowStyle }}">
                                    ...
                                    <td>{{ $score }}</td>
                                    <td><a href="{{ route('detailPainting', $auditor->id) }}"
...
@push('js')
    ...
    <script>
        var auditorsData = {!! json_encode($monthlyPainting) !!};
        var auditorNames = [];
        var auditorData = [];
        ...
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        @foreach ($monthlyPainting as $auditor)
