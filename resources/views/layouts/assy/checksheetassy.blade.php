...
@section('content')
    <form method="post" action="{{ route('answer.storeAssy') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="card-body">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <select name="auditor_id" id="auditor_name" class="form-control mb-4">
                        ...
                        {{-- Cek jika ada auditors yang belum mengisi --}}
                        @if (count($auditors) != 0)
...
@push('js')
    <script>
        // Ketika nilai auditor_name berubah
        $('#auditor_name').on('input', function() {
